...
i++;
    ...
    function removeCartItem(event) {
     ...
     let   cartItemTitle=buttonClicked.parentElement.parentElement.firstElementChild.lastElementChild.innerText
    ...
    function quantityChanged(event) {
        ...
        if (isNaN(input.value) || input.value <=0) {
            ...
            let   cartItemTitle=input.parentElement.parentElement.firstElementChild.lastElementChild.innerText
            removeProductFromLocalStorage(cartItemTitle)
        }
        updateCartTotal()
    }
...
function setProductInLocalStorage(title,price,imageSrc){
    ...
    product.push({product_title:title,product_price:price,product_image:imageSrc})
